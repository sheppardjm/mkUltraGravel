# Requirements Archive: v8.0 Visual Polish + Content
...
- [x] **PERF-03**: Lighthouse mobile Performance score ≥ 90 after all additions — achieved 96
- [x] **PERF-04**: TBT remains 0ms (no JS animation libraries) — confirmed 0ms
- [x] **PERF-05**: CLS ≤ 0.1 (gallery images sized, no layout shift) — achieved 0.073
...
**Shipped:** 25 of 25 v8.0 requirements
**Adjusted:**
- PHOTO-03 adjusted from 19 to 16 new photos (3 excluded by route owner)
- TOPO-02 upgraded from stroke-dashoffset to canvas metaball animation
- GAL-01 pivoted from horizontal flex strip to CSS columns masonry grid
**Dropped:** None

---
*Archived: 2026-04-01 as part of v8.0 milestone completion*
