...
**Goal**: Fix 7 issues found during v2.0 UAT — restore broken lightbox, card hover shadows, scroll-reveal animations, elevation crosshair sync, and update content/photos.
**Depends on**: Phase 15 (fixes applied to shipped v2.0)
**Plans**: 3 plans

Plans:
- [ ] 16-01-PLAN.md — CSS fixes: lightbox layer ordering, card hover shadow, scroll reveal keyframes, route stats text size
- [ ] 16-02-PLAN.md — JS fix: elevation crosshair getRelativePosition import
- [ ] 16-03-PLAN.md — Content + photo: MK Ultra explainer dual meaning, Leaving Chatham KOM photo
...
| 16. v2.0 UAT Fixes | v2.0 | 0/3 | In Progress | — |
