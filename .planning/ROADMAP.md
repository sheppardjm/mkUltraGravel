...
- [ ] **Phase 36: Environment Configuration** - Set all 8 Netlify env vars, verify GitHub PAT, confirm Strava callback domain
- [ ] **Phase 37: Data Pipeline Verification** - Verify GitHub commit → rebuild → leaderboard chain using crafted curl requests
...
Plans:
- [ ] 37-01: Verify GitHub commit → rebuild → leaderboard pipeline via crafted curl
